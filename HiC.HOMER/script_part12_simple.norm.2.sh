...
# script_part12_simpleNorm_runHiC_with_HOMER_part2.sh
############################################
...
analyzeHiC $FILE -res 10000000 -simpleNorm -cpu 12 -o "${FILE}.output.10mil.simpleNorm.Resolution.txt"

analyzeHiC $FILE -res 5000000 -simpleNorm -cpu 12 -o "${FILE}.output.5mil.simpleNorm.Resolution.txt"

analyzeHiC $FILE -res 2000000 -simpleNorm -cpu 12 -o "${FILE}.output.2mil.simpleNorm.Resolution.txt"
