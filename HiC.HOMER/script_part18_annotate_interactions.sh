...
############################################
FILE=$1
# script_part18_annotate_INTERACTIONS_hg38_with_HOMER.sh
############################################
...
### runHiCpca.pl "${FILE}.pca.res50kb"  $FILE -res 50000 -cpu 12 -genome hg38

### runHiCpca.pl "${FILE}.pca.res100kb" $FILE -res 100000 -cpu 12 -genome hg38

### tagDir2hicFile.pl $FILE -short "${FILE}.short.format.juicer" -genome hg38 -p 12

FILE=$1 

annotateInteractions.pl $FILE hg38 "${FILE}.folder.hg38"
